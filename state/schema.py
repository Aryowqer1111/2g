...
DEFAULT_STATE = {
    # --- ГЛОБАЛЬНОЕ ---
    "year": 1960, "month": 1, "turn": 0,  # 🔴 БЫЛО: "year ", "month ", "week " | 🟢 Убраны пробелы + удалён week
    ...
    "reform_policy": "centralized", "reform_intensity": 0.0,
    ...
    # --- БЛОК 4: СОЦИАЛЬНАЯ СФЕРА ---
    "thaw_index": 70.0, "ideology_rigidness": 50.0,
    "intelligentsia_mood": 65.0, "cultural_freedom": 60.0,
    ...
    # --- СОВМЕСТИМОСТЬ ---
    "stability": 70.0, "support": 65.0, "ideology": 70.0, 
    "prestige": 60.0, "security": 65.0,
